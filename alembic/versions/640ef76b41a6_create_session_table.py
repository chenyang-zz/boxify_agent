...
Revision ID: 640ef76b41a6
Revises: e9e60b8de4bb
Create Date: 2026-06-06 22:19:10.848886
...
revision: str = '640ef76b41a6'
down_revision: Union[str, Sequence[str], None] = 'e9e60b8de4bb'
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id', name='kp_sessions_id')
    )
