...
EventType = Literal["plan", "title", "step", "message", "tool", "wait", "error", "done"]
...
class BaseEvent(BaseModel):
    ...
    id: str = Field(default_factory=lambda: str(uuid4))  # 事件id
...
class PlanEvent(BaseEvent):
    ...
    plan: Plan  # 规划
    status: PlanEventStatus = PlanEventStatus.CREADED  # 规划事件状态
