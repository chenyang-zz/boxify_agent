...
class BrowserTool(BaseTool):
    ...
    @tool(
        ...
        description="查看浏览器当前页面内容，用于确认已打开页面的最新状态。",
        parameters={},
        required=[],
    )
    ...
    async def browser_restart(self, url: str) -> ToolResult:
        """重新启动浏览器并导航至指定URL"""
        return await self._browser.restart(url)
    ...
    async def browser_click(
        ...
        """点击当前页面中的元素"""
        return await self._browser.click(index, coordinate_x, coordinate_y)

    @tool(
        name="browser_input",
        description="覆盖浏览器当前页面可编辑区域的文本(input/textare输入框)，在需要填充输入表单时使用。",
        parameters={
            "text": {
                "type": "string",
    ...
    @tool(
        ...
        description="将鼠标光标移动到当前浏览器页面的指定位置，用于模拟用户的鼠标移动",
        parameters={
            "coordinate_x": {
                "type": "number",
                "description": "鼠标移动的目标X坐标",
            },
            "coordinate_y": {
                "type": "number",
                "description": "鼠标移动的目标Y坐标",
            },
        },
    ...
    async def browser_move_mouse(
        ...
        """将鼠标光标移动到指定位置"""
        return await self._browser.move_mouse(coordinate_x, coordinate_y)
    ...
    async def browser_select_option(
        ...
        """从当前浏览器页面的下拉列表元素中选择指定选项"""
        return await self._browser.select_option(index, option)
    ...
    async def browser_scroll_up(
        ...
        """向上滚动浏览器页面"""
        return await self._browser.scroll_up(to_top)
    ...
    async def browser_scroll_down(
        ...
        """向下滚动浏览器页面"""
        return await self._browser.scroll_up(to_down)
    ...
    async def browser_console_exec(
        ...
        return await self._browser.console_exec(javascript)
    ...
    async def browser_console_view(
        ...
        """查看浏览器控制台输出"""
        return await self._browser.console_view(max_lines)
